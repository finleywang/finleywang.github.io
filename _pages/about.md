...
To date, Prof. Wang has published over 50 peer-reviewed papers in top-tier journals including The Innovation, IEEE TKDE and IEEE TVT, as well as flagship conferences such as KDD, ICDE, VLDB, ICML, AAAI, NeurIPS, CVPR, CIKM, MM, ACL and so on. His scholarly outputs have accumulated more than 7,200 citations on Google Scholar, with an h-index of 28.
